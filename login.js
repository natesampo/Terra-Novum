...
function displayVerify(idToHide) {
	...
	document.getElementById('verify').style.top = '40vh';
	document.getElementById('verify').style.width = '100vw';
...
function displayLogin(idToHide) {
	...
	document.getElementById('login').style['margin-top'] = '20vh';
	document.getElementById('login').style.width = '30vw';
}
...
function displayGames(idToHide) {
	...
	document.getElementById('games').style['margin-top'] = '10vh';
	document.getElementById('games').style.width = '30vw';
}
...
function createGame() {
	...
	req.onreadystatechange = function() {
		if (this.readyState === XMLHttpRequest.DONE) {
			if (this.status === 200) {
				window.location.href = window.location.href + this.response;
			} else {
				displayLogin('games');
